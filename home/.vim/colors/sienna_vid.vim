...
if s:sienna_style == 'dark'
    ...
    hi Normal gui=none guifg=Grey85 guibg=#000001
    ...
    hi Search gui=none guifg=Black guibg=Sienna2
    ...
    "Marek Changed Special tag to Grey so that
    "javascript code embedded in html files would be
    "Easier to read
    "SkyBlue2 was the original color
    hi Special gui=none guifg=Grey85
